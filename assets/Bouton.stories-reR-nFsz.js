import{i as e}from"./preload-helper-DaCzexP6.js";import{u as t}from"./iframe-PPt9RSg7.js";import{l as n,r,v as i}from"./ri-BIHxbtjR.js";import{n as a,t as o}from"./button-BuKn-HD8.js";var s,c,l,u,d,f,p,m,h,g;e((()=>{s=t(),i(),a(),c={title:`Design system/Briques/Partagé/Bouton`,component:o,tags:[`autodocs`],parameters:{docs:{description:{component:[`Bouton partagé entre la vitrine et l’espace membre moderne.`,"Variantes (quasiment alignées DSFR) : `default` (primaire), `outline`","(secondaire), `secondary` (tertiaire), `ghost`, `link`,","`destructive`, `contrast` (blanc sur fond bleu/sombre). Tailles :","`lg` / `default` / `sm` / `xs` + variantes `icon-*`.","Pour un lien, utiliser `asChild` autour d’une balise `<a>`."].join(`
